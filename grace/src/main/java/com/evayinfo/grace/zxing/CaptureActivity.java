package com.evayinfo.grace.zxing;
...
import com.evayinfo.grace.zxing.common.BitmapUtils;
import com.evayinfo.grace.zxing.decode.BitmapDecoder;
import com.evayinfo.grace.zxing.decode.CaptureActivityHandler;
...
//				Toast.LENGTH_SHORT).show();
        onDecodeSuccess(ResultParser.parseResult(rawResult).toString());
    }
