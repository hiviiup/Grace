...
import com.iboomboom.grace.utils.DeviceUtils;
...
public class MediaHelper {
    ...
    public static Uri camera(Activity activity, String path, String imageName, String authority) {
        if (authority.isEmpty()) {
            throw new RuntimeException("请在清单文件中设置Provider，具体设置可查看本方法注释");
        }
        Uri imageUri;
     ...
     * </provider>
     *
     * @param fragment  调用相机的Activity
     * @param path      图片保存路径
     * @param imageName 图片名称
     */
    public static Uri camera(Fragment fragment, String path, String imageName, String authority) {
        if (authority.isEmpty()) {
            throw new RuntimeException("请在清单文件中设置Provider，具体设置可查看本方法注释");
        }
        Uri imageUri;
